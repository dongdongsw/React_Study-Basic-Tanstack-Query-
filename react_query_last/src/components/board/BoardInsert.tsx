                        ...
                        <table className={"table"}>
                            <tbody>
                                ...
                                <tr>
                                    <td width={"15%"}>내용</td>
                                    <td width={"85%"}>
                                        <textarea cols={55} rows={10} value={content} onChange={(e:any) :void  => setContent(e.target.value)}/>
                                    </td>
                                </tr>
                                <tr>
                                    <td width={"15%"}>비밀번호</td>
                                    <td width={"85%"}>
                                        <input type={"password"} size={15}  className={"input-sm"} ref={pwdRef} value={pwd} onChange={(e:any) :void  => setPwd(e.target.value)}/>
                                    </td>
                                </tr>
                                <tr>
